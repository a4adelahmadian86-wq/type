...
class AiOrchestrator
{
    ...
    public function run(User $user, string $operationName, string $text, array $context = []): array
    {
        ...
        $interaction = AiInteraction::create([
            'user_id'=>$user->id, 'document_id'=>$context['document_id'] ?? null, 'provider'=>$providerName, 'model'=>'pending',
        ...
        try {
            ...
            $contract = [
                'request_id'=>$requestId,'operation'=>$operation['name'],'provider'=>$providerName,'model'=>$resolvedModel,'processing_mode'=>$mode,'status'=>'completed',
