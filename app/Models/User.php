...
class User extends Authenticatable
{
    ...
    /**
     * Roles are deliberately constants rather than a second role table. The
     * existing users.role column remains the source of truth and can adopt
     * these values incrementally as organization/team authorization lands.
     */
