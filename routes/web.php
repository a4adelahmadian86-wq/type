...
Route::middleware('auth')->group(function(){
    ...
    Route::put('/account/profile',[AccountController::class,'updateProfile'])->middleware('throttle:20,10')->name('account.profile.update');
    Route::put('/account/preferences',[AccountController::class,'updatePreferences'])->middleware('throttle:20,10')->name('account.preferences.update');
    Route::put('/account/password',[AccountController::class,'updatePassword'])->middleware('throttle:10,10')->name('account.password.update');
...
Route::middleware(['auth','single.editor'])->group(function(){
    ...
    Route::post('/editor/ai/assist',EditorAiAssistController::class)->middleware('throttle:30,10')->name('editor.ai.assist');
